...
app.post('/myaction', function(req, res) {
   ...
   const sgMail = require('@sendgrid/mail');
    sgMail.setApiKey("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");  //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
